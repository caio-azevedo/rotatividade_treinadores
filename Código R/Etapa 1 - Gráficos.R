...
ggsave("vasco.eps", width = 20, height = 20, units = "cm")
...
ggsave("internacional.eps", width = 20, height = 20, units = "cm")
...
ggsave("cum_surpresa.eps", width = 20, height = 20, units = "cm")
...
ggsave("sob_surp.eps", width = 20, height = 20, units = "cm")
